...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        # 25.3.11修改，增加从本地读取vert/flame/ply的功能
        self.load_vert_meshes_flag = True
        self.result_save_path = ""
        self.vert_meshes_path = ""
        self.flame_path       = ""
        self.ply_path         = ""
        self._images = "images"
        self._resolution = -1
        ...
        # 25.4.2 支持传入多个part
        # ["left_check","lip","lower_chin","lower_nose","right_check","teeth","upper_chin"]        
        self.render_face_parsing_list=["all"]   
        self.render_face_parsing=False 
        self.render_parsed_mesh=False 
        self.render_parsed_mesh_background="no_background"
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        # 3D Gaussians
        self.iterations = 600_000 # 600_000  # 30_000 (original)
