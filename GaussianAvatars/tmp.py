...
if __name__ == "__main__":
    ...
    if stragegy == 1:
        ...
        args.model_path       = "output/UNION10EMOEXP_306_eval_1200k_start_from_600k"
        args.eval             = True
        ...
        args.save_iterations       = [iter_+600000 for iter_ in args.save_iterations]
        args.test_iterations       = [iter_+600000 for iter_ in args.test_iterations]
        args.checkpoint_iterations = [iter_+600000 for iter_ in args.checkpoint_iterations]
        args.full_geometry_opt_mode = True
        args.iterations = 1200000
    elif stragegy==2:
        args.source_path      = "data/UNION10_306_EMO1234EXP234589_v16_DS2-0.5x_lmkSTAR_teethV3_SMOOTH_offsetS_whiteBg_maskBelowLine"
        args.model_path       = "output/UNION10EMOEXP_306_eval_1200k_full_geo_opt"
        args.eval             = True
        args.bind_to_mesh     = True
        args.white_background = True
        args.port             = 40000
        # args.start_checkpoint = None
        args.save_iterations       = args.save_iterations+[iter_+600000 for iter_ in args.save_iterations]
        args.test_iterations       = args.test_iterations+[iter_+600000 for iter_ in args.test_iterations]
        args.checkpoint_iterations = args.checkpoint_iterations+[iter_+600000 for iter_ in args.checkpoint_iterations]
        args.full_geometry_opt_mode = True
        args.iterations = 1200000
