...
date:2025.03.10
note:
准备修改一下IO相关配置，更加灵活地完成gaussian+vert_mesh的渲染
修改前将原IO的代码进行备份
"""
...
def render_set(dataset : ModelParams, name, iteration, views, gaussians, pipeline, background, render_mesh):
    ...
    render_path = iter_path / "renders_id_only"
    render_mesh=True
    ...
    try:
        ...
        # TODO
        os.system(f"ffmpeg -y -framerate 25 -f image2 -pattern_type glob -i '{render_path}/*.png' -c:v libx264 -pix_fmt yuv420p {iter_path}/renders_average.mp4")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="./output/UNION10EMOEXP_306_eval_600k",type=str)
    args = get_combined_args(parser)
    # config input
    # args.model_path       = "./output/UNION10EMOEXP_306_eval_600k"
    args.skip_train       = True
    args.skip_val         = True
    args.select_camera_id = 6 # 8是正面
